...
See the [AOP guard example](/winter-boot/examples/aop-app) for a complete runnable app: a custom `#[RequireCustomHeader]` attribute protecting a REST endpoint with a `403` deny path.
