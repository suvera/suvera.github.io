...
<CardGrid>
  <LinkCard title="Doctrine" href="/modules/doctrine" description="Doctrine ORM and DBAL for entity management, DBAL, and multi-tenant datasources." />

  <LinkCard title="Redis" href="/modules/data-redis" description="PhpRedis client templates for singles, clusters, arrays, sentinels, and token rings." />

  <LinkCard title="Memcache" href="/modules/data-memcache" description="Memcached and Memcache client templates for lightweight caching." />

  <LinkCard title="Kafka" href="/modules/kafka" description="Apache Kafka producer and consumer integration for event streaming pipelines." />

  <LinkCard title="SQS" href="/modules/sqs" description="Amazon SQS producer and consumer with IAM role and IRSA support." />

  <LinkCard title="S3" href="/modules/s3" description="Amazon S3 and S3-compatible object storage from any bean." />

  <LinkCard title="OpenSearch" href="/modules/opensearch" description="OpenSearch indexing, querying, and AWS SigV4-signed access." />

  <LinkCard title="DTCE" href="/modules/dtce" description="Distributed Task Computing Engine for cross-node background task orchestration." />

  <LinkCard title="Eureka" href="/modules/eureka" description="Service discovery via Consul and Netflix Eureka." />

  <LinkCard title="Memdb" href="/modules/memdb" description="Embedded in-memory servers (Redis, Ignite, Memcached, Hazelcast) managed by the app lifecycle. *EXPERIMENTAL*" />

  <LinkCard title="Security" href="/modules/security" description="Application security policies for Winter Boot applications." />
