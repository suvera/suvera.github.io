...
| `dev\winterframework\dtce\task\storage\TaskQueueRedis` | Distributed | Requires the [Redis module](/winter-boot/modules/data-redis). |
| `dev\winterframework\dtce\task\storage\TaskQueueKafka` | Distributed | Requires the [Kafka module](/winter-boot/modules/kafka). |
...
| `dev\winterframework\dtce\task\storage\TaskIOStorageRedis` | Distributed | Requires the [Redis module](/winter-boot/modules/data-redis). |
...
<Aside type="tip">
  DTCE complements the built-in framework primitives. For single-process background work see [Async Tasks](/winter-boot/async/async-tasks) and [Scheduled Tasks](/winter-boot/async/scheduling); use DTCE when you need distributed, persistent task processing across nodes. Redis-backed queues use the [Redis module](/winter-boot/modules/data-redis); Kafka-backed queues use the [Kafka module](/winter-boot/modules/kafka).
</Aside>
