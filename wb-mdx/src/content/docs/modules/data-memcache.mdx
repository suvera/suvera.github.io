...
<Aside type="note">
  Client-only module. For the built-in framework caching abstraction see [Caching](/winter-boot/ops/caching); to launch an embedded Memcached server see [Memdb](/winter-boot/modules/memdb).
</Aside>
