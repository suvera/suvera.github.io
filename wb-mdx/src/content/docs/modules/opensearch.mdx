...
Version your index templates, ISM policies, and index schemas as JSON files and apply them with the built-in migration runner, tracked the same way as SQL migrations. See [OpenSearch Migrations](/winter-boot/data/opensearch-migrations).

<Aside type="tip">
  For object storage alongside search, see the [S3](/winter-boot/modules/s3) module.
</Aside>
