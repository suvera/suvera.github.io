...
<CardGrid>
  <LinkCard title="Quick Start" href="/winter-boot/quickstart" description="Install Winter Boot, create your first service and REST controller, and have a running Swoole HTTP server in minutes." />
  <LinkCard title="Core Concepts" href="/winter-boot/core/dependency-injection" description="Understand the application context, bean lifecycle, dependency injection, and AOP weaving that power every Winter Boot service." />
  <LinkCard title="Web & REST" href="/winter-boot/web/rest-controllers" description="Map HTTP routes with <code>#[RestController]</code>, handle path variables and request bodies, and return typed <code>ResponseEntity</code> objects." />
  <LinkCard title="Data Access" href="/winter-boot/data/database" description="Connect datasources, run schema migrations, and manage transactions declaratively with <code>#[Transactional]</code>." />
  <LinkCard title="Async & Scheduling" href="/winter-boot/async/async-tasks" description="Offload work with <code>#[Async]</code> coroutines and schedule recurring jobs with cron-style <code>#[Scheduled]</code> tasks." />
  <LinkCard title="Operations" href="/winter-boot/ops/caching" description="Add caching, distributed locking, structured logging, Prometheus metrics, and OpenTelemetry tracing to your services." />
</CardGrid>
