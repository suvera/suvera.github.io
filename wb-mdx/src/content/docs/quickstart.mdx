...
<CardGrid>
  <LinkCard title="Configuration" href="/winter-boot/configuration" description="Externalise settings with <code>application.yml</code>, <code>#[Value]</code>, and additional property sources." />
  <LinkCard title="Dependency Injection" href="/winter-boot/core/dependency-injection" description="Learn about bean scopes, qualifiers, and <code>#[PostConstruct]</code> lifecycle hooks." />
  <LinkCard title="REST Controllers" href="/winter-boot/web/rest-controllers" description="Handle path variables, request bodies, and return custom status codes." />
  <LinkCard title="Databases & Transactions" href="/winter-boot/data/database" description="Connect a datasource and manage transactions with <code>#[Transactional]</code>." />
  <LinkCard title="Async & Scheduling" href="/winter-boot/async/async-tasks" description="Run background jobs with <code>#[Async]</code> and <code>#[Scheduled]</code>." />
  <LinkCard title="Module System" href="/winter-boot/core/module-system" description="Add Redis, Kafka, Doctrine ORM, and other integrations via community modules." />
</CardGrid>
